<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center uppercase text-rose-800 font-bold">
                ...
                <div class="hidden space-x-8 lg:-my-px lg:ml-10 lg:flex">
                    ...
                    <x-nav-link :href="route('admin.grand.prize.winner.index')" :active="request()->routeIs('admin.grand.prize.winner.index')">
                        {{ __('Grand Prize Winners') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.grand.prize.winner.index')" :active="request()->routeIs('admin.grand.prize.winner.index')">
                {{ __('Grand Prize Winners') }}
            </x-responsive-nav-link>
        </div>
