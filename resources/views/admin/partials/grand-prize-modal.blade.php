<div class="z-50 hidden fixed h-screen w-screen justify-center items-center top-0" id="grandPrizeModal">

    <button type="button" id="grandPrizeModalBackdrop"
        class="inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50 fixed h-full top-0"></button>
    <div class="inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50 fixed h-full top-0">
        <div class="w-11/12 md:w-2/3 lg:w-3/5 xl:w-1/3 p-6 bg-white rounded-md">
            ...
            <div class="flex justify-end items-center">
                <button id="grandPrizeModalClose" type="button">
