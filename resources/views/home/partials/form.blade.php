<form action="" method="POST">
    ...
    <div class="font-black text-center text-6xl text-rose-800 drop-shadow-lg shadow-rose-500/50 mb-8">Spin The Wheel</div>
    <p class="text-sm font-medium text-gray-600">Win your share of RM10,000 worth of prizes with Yoodo! Which guaranteed prize is yours today? Spin & Win now!</p>
    ...
    <div class="mt-4">
        ...
        <x-input id="user_code" class="block mt-1 w-full" type="text" name="user_code" :value="old('user_code')" required />
    </div>
